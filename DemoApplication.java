            ...
            try (Statement funcionarios = conexao.createStatement();
                ...
                try (Statement salarios = conexao.createStatement();
                    ...
                    try (Statement Cargos = conexao.createStatement();
                        ...
                        while (cargos.next()) {
                            System.out.println("");
                            System.out.println("ID_Cargo: " + cargos.getString("ID_Cargos"));
                            System.out.println("Nome_Cargo: " + cargos.getString("nome_cargo"));
                        }

                        String queryDepartamentos = "select * from departamentos";
                        try (Statement departamentos = conexao.createStatement();
                             ResultSet Deparamentos = departamentos.executeQuery(queryDepartamentos)) {
                            System.out.println("");
                            System.out.println("ID_Departamento: " + Deparamentos.getString("ID_departamento"));
                            System.out.println("Nome_departamento: " + Deparamentos.getString("Nome_departamento"));
